      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {testimonials.map((testimonial, index) => (
            <Card key={index} className="card-shadow hover:elevated-shadow transition-smooth group">
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-8 items-center">
            {clientLogos.map((logo, index) => (
              <div 
                key={index} 
                className="flex items-center justify-center h-16 px-4 rounded-lg bg-card border border-border hover:border-accent/30 transition-smooth group"
              >
