          ...
          {services.map((service, index) => (
            <Card key={service.category} className="card-shadow hover:elevated-shadow transition-smooth group">
              <CardHeader className="text-center pb-8">
                <div className={`w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-br ${service.gradient} flex items-center justify-center group-hover:scale-110 transition-transform`}>
